package com.example.eightsweekone.view.details
...
import com.example.eightsweekone.databinding.FragmentHeroDetailsBinding
...
class HeroDetailsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val hero = arguments?.getSerializable("heroes") as HeroDTO
        setImage(hero.img)
        setData(hero)
    }
