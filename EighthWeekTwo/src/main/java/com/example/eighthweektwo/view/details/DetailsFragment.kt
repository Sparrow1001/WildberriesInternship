package com.example.eighthweektwo.view.details
...
import com.example.eighthweektwo.databinding.FragmentDetailsBinding
...
class DetailsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val hero = arguments?.getSerializable("heroes") as HeroResponse
        setImage(hero.images.sm)
        setData(hero)
    }
